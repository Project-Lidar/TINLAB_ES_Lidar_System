...
parser.add_argument('-H', '--host', required=False, default="mqtt://eecfbf0c:59ea275059b9c893@broker.shiftr.io")
parser.add_argument('-t', '--topic', required=False, default="humanMap")
parser.add_argument('-q', '--qos', required=False, type=int,default=0)
parser.add_argument('-c', '--clientid', required=False, default=None)
parser.add_argument('-u', '--username', required=False, default="eecfbf0c")
...
parser.add_argument('-p', '--password', required=False, default="Non59ea275059b9c893e")
